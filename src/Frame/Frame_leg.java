...
public class Frame_leg extends JFrame{
   ...
   public Frame_leg(Userinfo u) {
      List<Exercise> exlist = ex.ExList_leg();
      JFrame f = new JFrame("다리 운동");
    ...
    //Image
      ...
      ex1.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
            f.dispose();
            Frame_Base.getInstance(new Frame_ExerciseInfo(u,exlist.get(0),3));
         }
      });
      ...
      ex2.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
           f.dispose();
            Frame_Base.getInstance(new Frame_ExerciseInfo(u,exlist.get(1),3));
         }
      });
      ...
      ex3.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
            f.dispose();
            Frame_Base.getInstance(new Frame_ExerciseInfo(u,exlist.get(2),3));
         }
      });
