...
public class Frame_back extends JFrame{
   ...
   public Frame_back(Userinfo u) {
      List<Exercise> exlist = ex.ExList_back();
      JFrame f = new JFrame("등 운동");
    ...
    //Image
      ...
      f.add(jlimg2);
      f.add(jlimg3);
      jlimg1.setBounds(30,80,250,250);
      jlimg2.setBounds(30,300,250,250);
      jlimg3.setBounds(30,480,250,250);
      ...
      ex1.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
            f.dispose();
            Frame_Base.getInstance(new Frame_ExerciseInfo(u,exlist.get(0),2));
         }
      });
      ...
      ex2.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
           f.dispose();
            Frame_Base.getInstance(new Frame_ExerciseInfo(u,exlist.get(1),2));
         }
      });
      ...
      ex3.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
            f.dispose();
            Frame_Base.getInstance(new Frame_ExerciseInfo(u,exlist.get(2),2));
         }
      });
