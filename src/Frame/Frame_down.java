...
public class Frame_down extends JFrame{
   ...
   public Frame_down(Userinfo u) {
      List<Exercise> exlist = ex.ExList_down();
      JFrame f = new JFrame("하체 운동");
    ...
    //Image
      ...
      ImageIcon icn_333 = new ImageIcon((exlist.get(2)).ExName+3+".jpg");
      ...
      f.add(jlimg2);
      f.add(jlimg3);
      jlimg1.setBounds(30,90,250,250);
      jlimg2.setBounds(30,290,250,250);
      ...
      ex1.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
            f.dispose();
            Frame_Base.getInstance(new Frame_ExerciseInfo(u,exlist.get(0),5));
         }
      });
      ...
      ex2.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
           f.dispose();
            Frame_Base.getInstance(new Frame_ExerciseInfo(u,exlist.get(1),5));
         }
      });
      ...
      ex3.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
            f.dispose();
            Frame_Base.getInstance(new Frame_ExerciseInfo(u,exlist.get(2),5));
         }
      });
